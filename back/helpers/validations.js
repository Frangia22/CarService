...
const serviCardValidations = [
  ...
  check('type_of_oil').notEmpty().isString().isLength({ min: 3, max: 6 }).withMessage('Tipo de aceite es requerido y debe tener formato valido'),
  check('filter_of_oil').isBoolean().withMessage('Filtro de aceite tiene que ser true o false'),
  check('filter_of_air').notEmpty().isString().isLength({ min: 6, max: 9 }).withMessage('Filtro de aire es requerido y debe tener formato valido'),
  ...
  check('filter_anti_polen').notEmpty().isString().isLength({ min: 6, max: 9 }).withMessage('Filtro anti-polen es requerido y debe tener formato valido'),
  check('plugs').isBoolean().withMessage('Bujias tiene que ser true o false'),
  check('box_of_velocity').notEmpty().isString().isLength({ min: 5, max: 16 }).withMessage('Caja de velocidad es requerido y debe tener formato valido'),
